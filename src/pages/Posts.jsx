        ...
        <div className="w-full md:w-1/3 p-2">
          <div className="card w-full h-[300px] md:h-auto md:w-4/5 glass">
            <div className="flex flex-row py-4">
              ...
              <p className="flex-end text-sm capitalize pr-2 py-4">By UserMom 10.10.23 12:22</p>
            </div>
            ...
            <button onClick={handleLike} className={`focus:outline-none ${pulse ? 'animate-pulse' : ''}`}>
