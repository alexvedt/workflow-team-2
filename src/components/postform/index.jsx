...
export default function StyledPostForm({
    ...
    return (
        <form onSubmit={handleSubmit} className="glass editor mx-auto w-10/12 flex flex-col text-gray-800 p-4 shadow-lg max-w-2xl bg-base-100 rounded-2xl">
            <input
            ...
            <div className="buttons flex">
                ...
                <button type="submit" className="btn border border-secondary p-1 px-4 font-semibold cursor-pointer ml-2 bg-secondary rounded-2xl hover:rounded transition-all ease-in-out duration-300">
                    Post
                </button>
            </div>
        </form>
